...
class Config(object):
    ...
    API_HASH = os.getenv("API_HASH", "26954495")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "2061c55207cfee4f106ff0dc331fe3d9")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "MdiskSearchRobot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", -1002608186529))
    BOT_USERNAME = os.getenv("@SDMOVIEPOINTbot")
    BOT_OWNER = int(os.getenv("7951767281"))
#    OWNER_USERNAME = os.getenv("@Searching bot")
    BACKUP_CHANNEL = os.getenv("-1002409869914")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅''')
    ...
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "@Backup movie channel")
